...
import com.sun.tools.javac.tree.JCTree.JCGoto;
...
public class TreeMaker implements JCTree.Factory {
    ...
    public JCLabeledStatement Labelled(Name label, JCStatement body, GotoResolver resolver) {
        JCLabeledStatement tree = new JCLabeledStatement(label, body, resolver);
        tree.pos = pos;
        return tree;
    }
